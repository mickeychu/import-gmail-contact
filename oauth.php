...
<div id="tooplate_wrapper"><span id="top"></span>
  ...
  <div id="tooplate_main">
    ...
    <div class="content">
    <?php
$client_id = '822743733345-63kvc1r16hdv8jh532r8jq4rhlhkj3o3.apps.googleusercontent.com';
$client_secret = '8TnVkredoa8KnVOMhQaSVUH-';
...
foreach($temp['feed']['entry'] as $cnt) {
	/*echo $cnt['title']['$t'] . " --- " . $cnt['gd$email']['0']['address'] . "</br>";*/
	  ...
	  $email_list.= '<tr>
  					<td width="413">'.$count.'--'.$cnt['title']['$t'] . " --- " . $cnt['gd$email']['0']['address'].'</td>
